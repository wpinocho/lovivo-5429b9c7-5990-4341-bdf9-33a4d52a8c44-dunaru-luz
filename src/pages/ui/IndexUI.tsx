...
const CATALOG_FALLBACK: Record<string, { title: string; price: number; compare?: number; img: string }> = {
  ...
  'vela-rellenable-cuenco-dunaru': { title: 'Vela Rellenable · Cuenco Dunaru', price: 1199, img: `${IMG}biyop92l41t.webp` },
...
const SHOP_CARDS: { slug: string; tag: string; badge?: string }[] = [
  ...
  { slug: 'vela-rellenable-cuenco-dunaru', tag: 'Varias mechas', badge: 'Nuevo' },
  { slug: 'vela-bowl-de-acero', tag: 'Acero espejo' },
